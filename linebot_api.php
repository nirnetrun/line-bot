...
$channelAccessToken = 'Zdp4Onz24qW4VEy7PdFv9Wfu0feiCMZn4GQTNmVKAmvLWHpms2y02ADeL7W3eSkDQSVrhN6cignE5yywDmTIXUEkwtJPBhxrHffiMjTAOLMThGWRzZ1DJ/TYR5oDlJH6ROJkA8nKqvbGLu1d5knohwdB04t89/1O/w1cDnyilFU='; // Access Token ค่าที่เราสร้างขึ้น
...
foreach ($request_json['events'] as $event)
{
	if ($event['type'] == 'message') 
	{
		if($event['message']['type'] == 'text')
		{
			...
			if($text == "@บอท สวัสดี"){
					$reply_message = "สวัสดีจ้าๆๆ ยินดีให้บริการ";
				}
